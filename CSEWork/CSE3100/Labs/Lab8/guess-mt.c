...
int main(int argc, char *argv[]) {
    ...
    pthread_t generation, guess;
    check_pthread_return(pthread_create(&generation, NULL, thread_c, &arg), "Creation failed");
    check_pthread_return(pthread_create(&guess, NULL, thread_p, &arg), "Creation failed");

    check_pthread_return(pthread_join(generation, NULL), "Joining failed");
    check_pthread_return(pthread_join(guess, NULL), "Joining failed");
