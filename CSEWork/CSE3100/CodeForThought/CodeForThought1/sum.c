...
//Pay attention to whether the program is giving you the correct result
//Note the result of sum from 1 to n should be n*(n+1)/2
//You can use this formula to check the result geneated by the code.
//From the above inputs for n, find the minimum n that generates a wrong result,
...
//And then uncomment and make changes to the lines of code that follows and compile and
