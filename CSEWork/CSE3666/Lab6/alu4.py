...
def ALU4bits(a, b, alu_operation, result, zero):
    ...
    # We could use Python list to keep track of similar signals.
    ...
    alu1_1 = ALU1bit(a(0), b(0), bnegate, bnegate, operation, result0, c1)
    alu1_2 = ALU1bit(a(1), b(1), c1, bnegate, operation, result1, c2)
    alu1_3 = ALU1bit(a(2), b(2), c2, bnegate, operation, result2, c3)
    alu1_4 = ALU1bit(a(3), b(3), c3, bnegate, operation, result3, c4)
